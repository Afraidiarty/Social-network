            ...
            <div class="entry-container">
                <div class="buddypress profile">
                    <div class="profile-info">
                        <div class="profile-logo">
                            <img src="{{ asset('/public/storage/' . $user_info->id_image) }} " alt="">
                        </div>
                        <div class="profiles">
                            <div class="profile-up">
                                <h3 class="profile-name" > {{ $user_info->name }} </h3>
                                <div class="profile-role">{{ $user_info->role}}</div>
                            </div>
                            <div class="profile-middle">
                                Joined : {{ \Carbon\Carbon::parse($user_info->created_at)->format('F j, Y') }}
                            </div>                            
                            <div class="profile-counts">
                                <div class="counts">
                                    <div class="followers">
                                        <li><strong>{{ $user_info->Followers}}</strong> Followers</li>
                                    </div>
                                    <div class="following">
                                        <li><strong>{{ $user_info->Following}}</strong> Following</li>
                ...
                <div class="container-inner-bar">   
                    <div class="bar-menu-profile">
                        <a href="profile"><span class="{{ Route::currentRouteName() === 'profile' ? 'active' : '' }}">Activity</span></a>
                        <a href="Friends"><span>Friends</span></a>
                        <a href="Photos"><span>Photos</span></a>
                        <a href="inbox"><span>Messages</span></a>
                        <a href="Groups"><span>Groups</span></a>
                        <a href="Inviations"><span>Inviations</span></a>
                        <a href="Forums"><span>Forums</span></a>
                        <a href="{{ route('settings') }}"><span>Settings</span></a>
                        <a href="Point"><span>Point</span></a>
                    </div>
                </div>
            </div>  
...
<div class="bb">
     ...
     @if ($data->isEmpty())
        <section class="allposts error">
            <div class="block-error">
                <span class="material-symbols-outlined" style="color: #fff">error</span>
            </div>
            <div class="text-error">
                <span>Sorry!But users not have posts</span>
            </div>
        </section>
    @else
        @if ($user_info->id != $user['id'])
        <section class="allposts error">
            <div class="block-error">
                <span class="material-symbols-outlined" style="color: white" >new_releases</span>
            </div>
            <div class="text-error">
                <span>Success! Posts found! </span>
            </div>
        </section>
        @endif
    @endif
